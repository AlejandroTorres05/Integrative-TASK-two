...
public class GraphTestAM {
    GraphAM<Integer> integerGraph;
    GraphAM<String> stringGraph;

    public void setUpBidirectionalGraph1() {
        integerGraph = new GraphAM<>(true);
    }
    ...
    public void setUpDirectionalGraph1() {
        integerGraph = new GraphAM<>(false);
    }
